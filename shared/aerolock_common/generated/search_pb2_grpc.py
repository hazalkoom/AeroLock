...
class SearchServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SearchFlights = channel.unary_unary(
                '/aerolock.search.SearchService/SearchFlights',
...
def add_SearchServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'aerolock.search.SearchService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('aerolock.search.SearchService', rpc_method_handlers)
